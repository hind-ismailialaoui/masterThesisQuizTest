...
const FORCED_ANSWERS = {
  ...
  2: { index: 2, text: "Some parks are located in unsafe areas." },
  3: { index: 2, text: "Some mammals are dogs." },
  4: { index: 2, text: "Remote work always improves productivity." },
  5: { index: 2, text: "It assumes that all good cooks must be professional chefs." },
  6: { index: 2, text: "Alertness levels vary during the day." },
  7: { index: 1, text: "False cause" },
  8: { index: 2, text: "If school closes, it snowed." },
  9: { index: 1, text: "It appeals to authority." },
  10: { index: 1, text: "Invalid, because not all athletes are musicians." },
  ...
  15: { index: 2, text: "Training is optional for Sarah." },
  16: { index: 3, text: "Some books on this shelf are fiction." },
  17: { index: 1, text: "All doctors are scientists. Emily is a scientist. Therefore, Emily is a doctor." },
  18: { index: 1, text: "Competitors lowered prices significantly." },
  19: { index: 2, text: "Typing notes saves time." },
  20: { index: 3, text: "Faulty generalization" },
  21: { index: 4, text: "Some lawyers are teachers." },
  22: { index: 1, text: "All mammals are animals. Some animals are large. Therefore, some mammals are large." },
  23: { index: 1, text: "Other cities have used similar programs." },
  24: { index: 1, text: "Doctors recommend eating vegetables." },
  25: { index: 4, text: "The exam was difficult for everyone." },
  26: { index: 1, text: "This medicine worked for my friend, so it must work for me." },
  27: { index: 1, text: "Confusing cause with correlation" },
  28: { index: 3, text: "Some students who received an A failed the exam." },
  29: { index: 2, text: "Some painters are actors." },
  30: { index: 2, text: "If there is no fuel, the battery must be dead." },
};
const INTRO_IMAGES = [
